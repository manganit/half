...
public class JsonLayout extends Layout {
  ...
  /**
   * Method called near the end of formatting a LoggingEvent in case users want
   * to override the default object fields.
   *
  ...
  /**
   * Safe integer parser, for when line numbers aren't available.
   *
   * @param obj
   * @return
   */
